        ...
        <main class="page-main">
            <section class="page-section">
               <ul>
                    ...
                    <li>Apellidos:<strong><?php echo $lastName; ?></strong></li>
                    ...
                    <li>Nacionalidad:<strong><?php echo $naciolality; ?></strong></li>
