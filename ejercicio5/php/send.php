<?php
    ...
    $nacionality       = filter_input(INPUT_POST, 'nacionality', FILTER_SANITIZE_SPECIAL_CHARS);
    ...
    $phpmailer->AddAddress( 'dasaga.design@gmail.com', 'Daniel Sánchez ' );  // Correo del destinatario y nombre
    ...
    $phpmailer->Password   = '$Daniel_01*';                               // Contraseña del correo electrónico
    $phpmailer->From       = 'daniel@sfumino.mx';                       // From
